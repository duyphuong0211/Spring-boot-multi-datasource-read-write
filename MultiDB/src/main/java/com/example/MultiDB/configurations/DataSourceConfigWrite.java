package com.example.MultiDB.configurations;
...
import static com.example.MultiDB.DemoApplication.MODEL_PACKAGE;
...
@EnableJpaRepositories(
        ...
        basePackages = {"com.example.MultiDB.repository.writeRepository"} //
)
